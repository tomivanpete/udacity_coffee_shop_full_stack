...
def create_drink(payload):
    try:
        ...
        # Need to convert the recipe passed to a string
        # and replace single quotes with double quotes.
        # This avoids an error with json.loads when retrieving
        # drink recipes from the DB.
        recipe = str(request_body['recipe']).replace('\'', '\"')
...
def update_drink(payload, drink_id):
    ...
    # Accept update for title and/or recipe in the message body
    if title:
